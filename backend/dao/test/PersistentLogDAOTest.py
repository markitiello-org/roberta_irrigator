...
class TestPersistentLog(unittest.TestCase):
    ...
    def test_add_log(self):
        print("==== test add log =====")
        log_to_add = Log(zone_id=1, date_time=datetime.datetime.now(), event_id=EventId.general, log="Test log entry")
    ...
    def test_add_more_then_one_log(self):
        ...
        log_to_add_1 = Log(zone_id=2, date_time=None,event_id=EventId.irrigation_start, log="Irrigation started")
        log_to_add_2 = Log(zone_id=2, date_time=None,event_id=EventId.irrigation_stop, log="Irrigation ended")
        sleep(1)
        log_to_add_3 = Log(zone_id=2, date_time=None,event_id=EventId.irrigation_start, log="Irrigation started")
        log_to_add_4 = Log(zone_id=2, date_time=None,event_id=EventId.irrigation_stop, log="Irrigation ended")
