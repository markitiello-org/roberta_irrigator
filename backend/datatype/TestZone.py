...
class TestInitSqlLite(unittest.TestCase):
    ...
    def test_TimeToOpen_ThenZoneIsOpen(self):
        ...
        irrigation_info = [
            IrrigationInfo(datetime.time(10, 20, 00, 00), 120),
            IrrigationInfo(datetime.time(22, 20, 00, 00), 120),
        ]
    ...
    def test_TryToOpenAZoneWithTheRigtTimeButNotRightDayOfTheWeek_ThenZoneIsClosed(
        self,
    ):
        irrigation_info = [
            IrrigationInfo(datetime.time(10, 20, 00, 00), 120, [2, 3, 4, 5, 6]),
            IrrigationInfo(datetime.time(22, 20, 00, 00), 120, [2, 3, 4, 5, 6]),
        ]
        zone = Zone("test", 1, irrigation_info)
        now = datetime.time(10, 19, 00, 00)
